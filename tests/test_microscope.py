...
#         json_meta, raw_bytes = microscope_proxy.acquire_scanned_image()
#         meta = json.loads(json_meta)
...
#             microscope_proxy.acquire_scanned_image("nonexistent_detector")